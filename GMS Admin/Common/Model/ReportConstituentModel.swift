...
class ReportConstituentListModel: NSObject {
    ...
    // MARK: Class Method
    class func build(_ dict: [String: AnyObject]) -> ReportConstituentListModel {
        let reportBirthdayModel = ReportConstituentListModel()
