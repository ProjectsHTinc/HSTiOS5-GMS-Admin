...
class ReportFestivalVc: UIViewController,PaguthiView,OfficeView,ReportFestivalView,UIPickerViewDataSource,UIPickerViewDelegate, BirthdayYearView {
    ...
    @IBOutlet var festival: TextFieldWithImage!
...
//        self.showDatePicker()
    ...
    func callAPIFestival ()
    {
        presenterfestival.attachView(view: self)
        presenterfestival.getfestival(dynamic_db:GlobalVariables.shared.dynamic_db)
    }
    ...
    func createPickerView() {
         ...
         festival.inputAccessoryView = toolBar
         fromDate.inputAccessoryView = toolBar
         toDate.inputAccessoryView = toolBar
    }
    ...
    @objc func action() {
      ...
      else if self.festival.isFirstResponder{
        self.festival.text = self.festivalName[row]
        self.selectedFestivalId = self.festivalId[row]
      }
    ...
    @IBAction func search(_ sender: Any)
    {
        ...
        self.from = "festival"
        self.performSegue(withIdentifier: "festivalList", sender: self.from)
...
//             }
    ...
    func pickerView(_ pickerView: UIPickerView, numberOfRowsInComponent component: Int) -> Int {
      ...
      else if toDate.isFirstResponder{
          return self.birtdayYearArr.count
      }
      else {
          return self.festivalName.count
      }
    }
    ...
    func setFestival(reportFestivalData: [ReportFestivalData]) {
        ...
        for items in festivalData {
            ...
            let festivals = items.festival_name
             let id = items.id!
             self.festivalName.append(festivals!.capitalized)
            self.festivalId.append(id)
 //            pickerView.reloadAllComponents()
         }
...
//
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if (segue.identifier == "festivalList")
        {
            ...
            vc.festival = selectedFestivalId
        }
    }
}
