...
let reportBirthdaySearchUrl = "apiandroid/reportBirthdaysearch"
...
//        presenter.getReportBirthday(url: url, select_month: select_month, keyword: keyword, offset: offset, rowcount: rowcount,dynamic_db:GlobalVariables.shared.dynamic_db)
    }
