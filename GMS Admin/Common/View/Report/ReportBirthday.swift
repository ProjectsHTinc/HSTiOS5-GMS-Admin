...
let reportBirthdayUrl = "apiandroid/reportBirthdaynew"
...
//        presenter.getReportBirthday(url: url, select_month: select_month, keyword: keyword, offset: "0", rowcount: "50",dynamic_db:GlobalVariables.shared.dynamic_db)
    }
